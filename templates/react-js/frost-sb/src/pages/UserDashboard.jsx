      ...
      <main className="flex-1 md:ml-64 p-6 md:p-10">
        <header className="flex flex-col md:flex-row md:justify-between md:items-center mb-10 gap-6">
          <div className="fade-in">
            <h1 className="text-3xl font-bold text-[var(--text-main)] tracking-tight">Hello, <span className="text-[var(--color-accent)]">{userData?.name || 'User'}</span></h1>
            <p className="text-[var(--text-secondary)] font-medium mt-1">Here's what's happening today</p>
          </div>
          ...
          <div className="flex items-center gap-4 fade-in">
            ...
            <div className="flex items-center gap-3 pl-2 pr-5 py-2 glass-panel rounded-2xl shadow-sm">
              ...
              <div className="hidden sm:block">
                <p className="text-sm font-bold text-[var(--text-main)] leading-none">{userData?.name || 'User'}</p>
                <p className="text-[var(--text-muted)] text-xs mt-1 leading-none">{userData?.email}</p>
              </div>
            </div>
          </div>
        </header>
          ...
          {activeTab === 'overview' && (
            <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-6 fade-in">
              ...
              <div className="md:col-span-2 lg:col-span-2 bento-card">
                ...
                <p className="text-[var(--text-muted)] text-xs font-bold uppercase tracking-wider">Account Status</p>
              ...
              <div className="md:col-span-2 lg:col-span-2 bento-card">
                ...
                <p className="text-[var(--text-muted)] text-xs font-bold uppercase tracking-wider">Profile Setup</p>
                <p className="text-3xl font-bold text-[var(--color-accent)] mt-2">Complete</p>
              </div>
              ...
              <div className="md:col-span-4 lg:col-span-2 bento-card">
                ...
                <p className="text-[var(--text-muted)] text-xs font-bold uppercase tracking-wider">Notifications</p>
                <p className="text-3xl font-bold text-amber-500 mt-2">0 New</p>
              </div>

              <div className="md:col-span-4 lg:col-span-4 bento-card md:row-span-2">
                ...
                <div className="space-y-6">
                  <div className="flex gap-4 p-4 rounded-2xl bg-[var(--glass-bg)] border border-[var(--glass-border)]">
                    <div className="w-8 h-8 rounded-lg bg-[var(--color-accent-muted)] text-[var(--color-accent)] flex items-center justify-center font-bold text-sm shrink-0">1</div>
                    <div>
                      <p className="font-bold text-[var(--text-main)]">Customize Profile</p>
                      <p className="text-sm text-[var(--text-secondary)] mt-1">Head over to settings to update your display name and preferences.</p>
                    </div>
                  </div>
                  <div className="flex gap-4 p-4 rounded-2xl bg-[var(--glass-bg)] border border-[var(--glass-border)]">
                    <div className="w-8 h-8 rounded-lg bg-[var(--color-accent-muted)] text-[var(--color-accent)] flex items-center justify-center font-bold text-sm shrink-0">2</div>
                    <div>
                      <p className="font-bold text-[var(--text-main)]">Security Check</p>
                      <p className="text-sm text-[var(--text-secondary)] mt-1">Ensure your account is secure with our Supabase-powered authentication.</p>
                    </div>
                  </div>
                </div>
              </div>

              <div className="md:col-span-2 lg:col-span-2 bento-card flex flex-col justify-center items-center text-center">
                <p className="text-[var(--text-muted)] text-[10px] font-bold uppercase tracking-widest mb-2">Member Since</p>
                <p className="text-2xl font-bold text-[var(--text-main)]">{createdAt}</p>
              </div>
            </div>
          )}
            ...
            <div className="max-w-3xl fade-in">
              <div className="glass-card p-8 md:p-12 hover:scale-100">
                <div className="flex items-center gap-4 mb-10">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-[var(--text-main)]">Profile Settings</h3>
                    <p className="text-[var(--text-secondary)] font-medium">Manage your public information</p>
                  </div>
                </div>
                ...
                <form onSubmit={handleProfileUpdate} className="space-y-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-[var(--text-muted)] ml-1">Account Created</label>
                      <div className="px-4 py-3 rounded-[var(--input-radius)] bg-[var(--glass-bg)] text-[var(--text-muted)] font-medium text-sm">
                        {createdAt}
                      </div>
                    </div>
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-[var(--text-muted)] ml-1">Your Role</label>
