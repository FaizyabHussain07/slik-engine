// nexus — components/layout/Footer.tsx
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-[var(--muted)] max-w-[200px]">
              Where great teams ship faster.
            </p>
          ...
          {/* Product */}
          <div>
            <h3 className="font-mono text-[11px] uppercase tracking-widest text-[var(--muted)] mb-4">
              Product
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <FooterLink href="/careers">
                Careers <span className="text-[var(--accent)] text-xs">Hiring</span>
              </FooterLink>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-[var(--border)] pt-6 flex flex-wrap justify-between gap-4">
